        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CardSets_AspNetUsers_CardSmithId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SymbolUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Power = table.Column<int>(type: "int", nullable: false),
                    Toughness = table.Column<int>(type: "int", nullable: false),
                    ArtId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SetOfCardId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SetOfCardsId = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Cards_CardSets_SetOfCardsId",
                        column: x => x.SetOfCardsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VarSymbols_CardSets_SetOfCardsId",
                        column: x => x.SetOfCardsId,
                        principalTable: "CardSets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ManaSymbols_CardSets_SetOfCardsId",
                        column: x => x.SetOfCardsId,
                        principalTable: "CardSets",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_SetOfCardsId",
                table: "Cards",
                column: "SetOfCardsId");

            migrationBuilder.CreateIndex(
                name: "IX_CardSets_CardSmithId",
                table: "CardSets",
                column: "CardSmithId");

            migrationBuilder.CreateIndex(
                name: "IX_CardSets_IsDeleted",
                table: "CardSets",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManaSymbols_SetOfCardsId",
                table: "ManaSymbols",
                column: "SetOfCardsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VarSymbols_SetOfCardsId",
                table: "VarSymbols",
                column: "SetOfCardsId");
        }
