        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Article_AspNetUsers_ArticleCreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManaColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Colorless = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DigitalArts_PlayCards_PlayCardId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DigitalArtId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    StoreImageId = table.Column<int>(type: "int", nullable: true),
                    ProjectIdImage = table.Column<int>(type: "int", nullable: false),
                    ProjectImageId = table.Column<int>(type: "int", nullable: true),
                    TournamentImageId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_Article_ArticleId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Images_DigitalArts_DigitalArtId",
                        column: x => x.DigitalArtId,
                        principalTable: "DigitalArts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Images_GameFormatProjects_ProjectImageId",
                        column: x => x.ProjectImageId,
                        principalTable: "GameFormatProjects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Images_StoreTournaments_TournamentImageId",
                        column: x => x.TournamentImageId,
                        principalTable: "StoreTournaments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Images_Stores_StoreImageId",
                        column: x => x.StoreImageId,
                        principalTable: "Stores",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Article_ArticleCreatorId",
                table: "Article",
                column: "ArticleCreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Article_IsDeleted",
                table: "Article",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DigitalArts_PlayCardId",
                table: "DigitalArts",
                column: "PlayCardId",
                unique: true,
                filter: "[PlayCardId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_StoreImageId",
                table: "Images",
                column: "StoreImageId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_TournamentImageId",
                table: "Images",
                column: "TournamentImageId");
