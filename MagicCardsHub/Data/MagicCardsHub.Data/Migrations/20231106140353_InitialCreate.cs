        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Arts_AspNetUsers_ArtIstId",
                        column: x => x.ArtIstId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpansionCardDecks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpansionCardDecks_AspNetUsers_CardSmithId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FrameColorUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalCardId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExpansionDeckId = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardInDeck", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CardInDeck_ExpansionCardDecks_ExpansionDeckId",
                        column: x => x.ExpansionDeckId,
                        principalTable: "ExpansionCardDecks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManaSymbols", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ManaSymbols_Cards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VarSymbols", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VarSymbols_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardInDeck_ExpansionDeckId",
                table: "CardInDeck",
                column: "ExpansionDeckId");

            migrationBuilder.CreateIndex(
                name: "IX_CardInDeck_IsDeleted",
                table: "CardInDeck",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpansionCardDecks_CardSmithId",
                table: "ExpansionCardDecks",
                column: "CardSmithId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpansionCardDecks_IsDeleted",
                table: "ExpansionCardDecks",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ManaSymbols_CardId",
                table: "ManaSymbols",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_ManaSymbols_IsDeleted",
                table: "ManaSymbols",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VarSymbols_CardId",
                table: "VarSymbols",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_VarSymbols_IsDeleted",
                table: "VarSymbols",
                column: "IsDeleted");
        }
