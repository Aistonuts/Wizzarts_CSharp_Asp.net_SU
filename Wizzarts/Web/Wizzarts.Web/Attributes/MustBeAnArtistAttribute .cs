namespace Wizzarts.Web.Attributes
{
    ...
    public class MustBeAnArtistAttribute : ActionFilterAttribute
    {
        ...
        public async Task OnActionExecutingAsync(ActionExecutingContext context)
        {
            ...
            if (user != null && (currentRole.Contains(ArtistRoleName) == false || currentRole.Contains(AdministratorRoleName) == false))
            {
