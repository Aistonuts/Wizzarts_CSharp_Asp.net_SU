namespace Wizzarts.Web.Areas.Administration.Controllers
{
    ...
    public class UserController : AdministrationController
    {
        ...
        public async Task<IActionResult> All(int id = 1)
        {
            ...
            if (premium == null)
            {
                premium = this.userManager.GetUsersInRoleAsync(GlobalConstants.ContentCreatorRoleName).Result;
            ...
            var viewModel = new UserListViewModelAdminArea
            {
                ...
                StoreOwners = storeOwners.Select(x => new UserInListViewModelAdminArea
                {
                    Id = x.Id,
                    Email = x.Email,
                    Nickname = x.Nickname,
                ...
                Premium = premium.Select(x => new UserInListViewModelAdminArea
                {
                    Id = x.Id,
                    Email = x.Email,
                    Nickname = x.Nickname,
