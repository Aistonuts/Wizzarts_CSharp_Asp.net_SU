namespace Wizzarts.Common
{
    public static class DataConstants
    {
        ...
        public const int ArtTitleMinLength = 1;

        public const int ArtDescriptionMaxLength = 500;

        public const int ArtDescriptionMinLength = 2;
        ...
        public const int ArticleShortDescriptionMaxLength = 500;

        public const int ArticleShortDescriptionMinLength = 10;

        public const int ArticleDescriptionMaxLength = 1000;
        ...
        public const int CardReviewMinLength = 5;

        public const int CardReviewSuggestionMaxLength = 500;

        public const int CardReviewSuggestionMinLength = 5;
        ...
        // Event milestones Constants
        public const int EventMilestoneTitleMaxLength = 100;

        public const int EventMilestoneTitleMinLength = 5;

        public const int EventMilestoneDescriptionMaxLength = 1000;
        ...
        public const int StorePhoneMaxLength = 15;
