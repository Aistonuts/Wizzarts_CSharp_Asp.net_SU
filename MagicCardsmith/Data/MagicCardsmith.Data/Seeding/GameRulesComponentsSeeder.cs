...
namespace MagicCardsmith.Data.Seeding
{
    ...
    internal class GameRulesComponentsSeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            if (dbContext.GameRulesComponents.Any())
            {
                return;
            }

            await dbContext.GameRulesComponents.AddAsync(new GameRulesComponents
            {
                Title = "Creatures",
