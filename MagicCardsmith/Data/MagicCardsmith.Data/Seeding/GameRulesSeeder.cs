namespace MagicCardsmith.Data.Seeding
{
    ...
    public class GameRulesSeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            if (dbContext.GameRules.Any())
            {
                return;
            }

            await dbContext.GameRules.AddAsync(new MagicCardsmithGameRules
            {
                Title = "Magic cardsmith game rules",
                PublishedById = "2b346dc6-5bd7-4e64-8396-15a064aa27a7",
                Description = "Welcome to Magic Cardsmith!" +
                ...
                "Here you'll find everything you need to learn how to play Magic Cardsmith.",
                GameRulesIntroUrl = "/images/navigation/rulesNav/MCSGameRules.png",
                CardReading = "Card reading is a very important part of the game. A Magic cardsmith card has a name, mana cost, type, symbol, textbox with abiliities and flavour and power and toughness.",
                ...
                CardTypeReading = "Card type : Every card in Magic Cardsmith has a type, such as Land, Creature, Artifact, Enchantment, Instant and Sorcery",
                ...
                CardTextBoxReading = "Card text : Rules text explains special effect a card has during gameplay. Flavour text does not affect gameplay, but exists to provide the backstory of the card.",
                ...
                BattleFieldSetUp = "In Magic Cardsmith, a spell is any type of card cast by a player. Spells are usually cast from your hand, but in special cases can be cast from other areas of the battlefield like your library or your graveyard. Land cards are the only type of card that is not considered a spell.",
