namespace MagicCardsmith.Web.Areas.Administration.Models.Users
{
    ...
    public class SingleUserViewModel : PagingViewModel, IMapFrom<ApplicationUser>, IHaveCustomMappings
    {
        ...
        {
            configuration.CreateMap<ApplicationUser, SingleUserViewModel>()
